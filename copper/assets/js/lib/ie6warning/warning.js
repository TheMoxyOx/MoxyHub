...
var msg2 = "Internet Explorer 6 provides limited functionality and we cannot guarantee that all of the features in Copper will work. Our strongest recommendation is to install Firefox or Chrome for the quickest and safest Copper experience. Stay safe kiddies, and ditch that old browser.";
var msg3 = "A list of some popular alternatives can be found below. Just click on the icons to gp to the download page";
...
{
	var backing = document.getElementById('_d');
	backing.parentNode.removeChild(backing);

	var content = document.getElementById('_l');
