...
include_once('../quote/jcart/jcart.php');
...
<form class="col-lg-8 text-right" action="quote.php" method="get">
	...
	<input id="zip" type="text" name="width"><br>
	...
	<textarea id="notes" rows="10" cols="30" name="notes"></textarea><br><br>
